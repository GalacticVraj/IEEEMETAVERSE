...
- `simulation-state.ts` — `SimulationState` FSM vocabulary (rules live in `@kernel/fsm`).

**Phase 1:** **Ready** — real; the shared vocabulary the whole codebase types against.
